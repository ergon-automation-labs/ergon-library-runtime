defmodule BotArmyRuntime.Outcomes do
  @moduledoc """
  ...
  ## Usage
      ...
      BotArmyRuntime.Outcomes.emit("advocacy", "decision", "proposal_approved", 1,
        metadata: %{proposal_id: "abc", bill_id: "123"}
      )

      BotArmyRuntime.Outcomes.emit("notification_router", "routing", "route_to_discord", 1,
