defmodule BotArmyRuntime.Personality.Voice do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> BotArmyRuntime.Personality.Voice.gossip(:chore_bot, :check_in, count: 3)
      "⟳ Standing by. 3 pending."

      iex> BotArmyRuntime.Personality.Voice.gossip(:sre_terminal, :celebrate, metric: "7")
