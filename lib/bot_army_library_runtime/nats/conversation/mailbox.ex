defmodule BotArmyLibraryRuntime.NATS.Conversation.Mailbox do
  @moduledoc """
  ...
  alias BotArmyLibraryRuntime.NATS.Conversation.Envelope
  ...
  decode and handle. Use `BotArmyLibraryCore.NATS.Decoder.decode/1` or
