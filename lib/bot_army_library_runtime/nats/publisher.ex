defmodule BotArmyLibraryRuntime.NATS.Publisher do
  @moduledoc """
  ...
  ## Usage
      ...
      {:ok, _} = BotArmyLibraryRuntime.NATS.Publisher.publish("bot.task.created", event_data)

  ## Configuration

  Uses NATS configuration from `:bot_army_runtime, :nats` (same as `BotArmyLibraryRuntime.NATS.Connection`).
