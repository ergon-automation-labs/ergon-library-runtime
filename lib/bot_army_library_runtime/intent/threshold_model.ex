defmodule BotArmyLibraryRuntime.Intent.ThresholdModel do
  @moduledoc """
  ...
  ## Usage
      ...
      alias BotArmyLibraryRuntime.Intent.{ThresholdModel, AccumulatedContext, Publisher}
  ...
  defp roll_random(bot_name, action) do
    ...
    case BotArmyLibraryRuntime.NATS.Publisher.request("bridge.random.roll", payload, timeout_ms: timeout) do
  ...
  defp get_in_config([key], default) do
    config = Application.get_env(:bot_army_library_runtime, :threshold_model, [])
