defmodule BotArmyLibraryRuntime.Intent.AccumulatedContext do
  @moduledoc """
  ...
  defp via(bot_name) do
    {:via, Registry,
     {BotArmyLibraryRuntime.AccumulatedContextRegistry, {:accumulated_context, bot_name}}}
  end

  defp whereis(bot_name) do
    case Registry.lookup(
           BotArmyLibraryRuntime.AccumulatedContextRegistry,
  ...
  defp ensure_started(bot_name) do
    case whereis(bot_name) do
      nil ->
        ...
        case DynamicSupervisor.start_child(BotArmyLibraryRuntime.DynamicSupervisor, spec) do
          {:ok, _pid} ->
            :ok
