defmodule BotArmyLibraryRuntime.Logging do
  @moduledoc """
  ...
  ```elixir
  BotArmyLibraryRuntime.Logging.record("Task completed successfully", source: "advocacy_bot")
  BotArmyLibraryRuntime.Logging.record("New bill found", source: "advocacy_bot", category: "work", tags: ["bill", "federal"])
  ```
