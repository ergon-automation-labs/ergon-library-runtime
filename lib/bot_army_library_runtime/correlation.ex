defmodule BotArmyLibraryRuntime.Correlation do
  @moduledoc """
  ...
  **Entry point (generate on user request):**
      BotArmyLibraryRuntime.Correlation.put(BotArmyLibraryRuntime.Correlation.generate())

  **Consumer (extract from incoming message):**
      BotArmyLibraryRuntime.Correlation.extract_from_headers(msg.headers)
      |> case do
  ...
  **Publisher (auto-injected):**
      headers = BotArmyLibraryRuntime.Correlation.inject_into_headers([])
