defmodule BotArmyLibraryRuntime.Config do
  @moduledoc """
  ...
  In your bot's config.exs:
      ...
      import BotArmyLibraryRuntime.Config
  ...
  defmacro logger_config(opts \\ []) do
    ...
    quote do
      config :logger,
        level: unquote(level),
        backends: [:console],
        default_formatter: {BotArmyLibraryRuntime.LoggerFormatter, unquote(include_fields)}

      config :logger, :console,
        format: {BotArmyLibraryRuntime.LoggerFormatter, unquote(include_fields)},
  ...
  defmacro minimal_logger_config do
    quote do
      config :logger,
        level: :info,
        backends: [:console],
        default_formatter: {BotArmyLibraryRuntime.LoggerFormatter, []}

      config :logger, :console,
        format: {BotArmyLibraryRuntime.LoggerFormatter, []},
